...
int taskCount = 2; // кол-во задач текущего семинара (от 1 до 9). надеюсь более 9 задач не будет =)

string MenuItemName(int taskNamber) // наименования пунктов меню
{
    switch (taskNamber)
    {
        case 1: return "Задача № HARD-2"; // Task1.cs
        case 2: return "Задача № 41"; // Task2.cs
        case 3: return "Задача № 38"; // Task3.cs
        case 4: return "Задача HARD STAT"; // Task4.cs
